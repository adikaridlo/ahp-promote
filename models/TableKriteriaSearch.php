...
/**
 * TableKriteriaSearch represents the model behind the search form of `app\models\TableKriteria`.
 */
class TableKriteriaSearch extends TableKriteria
{
    /**
     * {@inheritdoc}
     */
