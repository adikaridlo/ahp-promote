...
/**
 * MatrixKriteriaSearch represents the model behind the search form of `app\models\MatrixKriteria`.
 */
class MatrixKriteriaSearch extends MatrixKriteria
{
    /**
     * {@inheritdoc}
     */
