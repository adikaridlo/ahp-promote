            ...
            'columns' => [
                ...
                [
                    ...
                    'value'                 => function($model){
                        return \app\components\Helper::dateTimeFormat($model['created_date']);
                    },
                    'filterInputOptions'    => [
                    ...
                    'buttons' => [
                        'activate' => function ($url, $model) {
                            if ($model->is_active == 1) {
                                return Html::a(
                                    '<button type="button" class="btn btn-sm btn-danger btn-xs">Inactive</button>',
                                    $url,
                                    [
                                        'title' => 'Inactive',
                                        'data-pjax' => '0',
                                ...
                                return Html::a(
                                    '<button type="button" class="btn btn-sm btn-success btn-xs">
                                        <span>Activate</span>
                                    </button>',
                                    $url,
                                    [
